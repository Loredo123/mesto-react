        ...
        <main className="content">
            <section className="profile">
                ...
                <div className="profile__info">
                    <h1 className="profile__name overflow-text-content">{currentUser.name}</h1>
                    <button onClick={props.onEditProfile} aria-label="Редактировать" type="button" className="profile__edit-button button"></button>
                    <p className="profile__comment overflow-text-content">{currentUser.about}</p>
                ...
                <ul className="gallery__grid">
                    {
                        ...
                        props.cards.map((card) => {
                            ...
                            return (
                                <Card onCardDelete={props.onCardDelete} onCardLike={props.onCardLike} onCardClick={props.onCardClick} key={card._id} item={card} {...card} />
                            )
                        })
